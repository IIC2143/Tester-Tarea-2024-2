...
def test_3A():
    ...
    results = {
        ...
        6: post_players(games[0], players[0]),
        7: post_players(games[0], players[1]),
        8: post_players(games[0], players[2]),
        ...
        13: post_review(games[0], players[3], reviews[5]),
        ...
        17: get_player_from_review(reviews[0], players),
        18: delete_worst_game(games),
